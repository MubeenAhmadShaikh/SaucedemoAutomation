...
class TestE2E(BaseClass):
    ...
    def e2e_purchase(self, scenario, get_logger):
        ...
        if scenario == 'purchase_all_product':
            ...
            self.selectOptionByText(products_list_page.get_sort_menu(), "Price (low to high)")
            ...
            self.selectOptionByText(products_list_page.get_sort_menu(), "Price (high to low)")
            prices = products_list_page.get_all_product_prices()
        ...
        # Checkout form page validations
        # checkout_page = checkout_form_page.getContinueButton()
